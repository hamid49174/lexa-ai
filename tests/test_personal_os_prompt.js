...
assert("Personal OS detail and review labels are localized", src.includes('posUiText("pos.labelReviewAssist"') && src.includes('posUiText("pos.labelApplyBoundary"') && src.includes('posUiText("pos.labelChatReviewPrompt"') && src.includes('posUiText("pos.labelTargetReview"') && src.includes('posUiText("pos.metricApprovedBox"') && src.includes('posUiText("pos.targetLoadedNoDiff"') && i18nDe.includes('"pos.labelReviewAssist"') && i18nEn.includes('"pos.labelReviewAssist"') && i18nDe.includes('"pos.metricApprovedBox"') && i18nEn.includes('"pos.metricApprovedBox"'));
