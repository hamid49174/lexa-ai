...
assert("i18n includes new Hermes/fallback/media labels", deI18n.includes('"dashboard.aiFallback"') && enI18n.includes('"settings.anthropicDesc"') && deI18n.includes('"settings.hermesGatewayAutostart"') && deI18n.includes('"system.hermesCockpitTitle"') && deI18n.includes('"system.hermesCapabilityGaps"') && deI18n.includes('"system.hermesProviders"') && deI18n.includes('"system.hermesMedia"') && deI18n.includes('"system.startupHealthTitle"') && enI18n.includes('"system.startupHealthTitle"') && enI18n.includes('"system.hermesMedia"'));
