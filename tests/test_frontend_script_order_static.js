...
assert("chat does not auto-execute or visibly block local tools from normal chat responses", !chatSrc.includes("window.lexa.execute(") && !chatSrc.includes("window.lexa.executeWithConfirmation(") && !chatSrc.includes("window.lexa.prepareCompanionExecute(") && !chatSrc.includes("window.confirm(") && chatSrc.includes("handleChatToolActionBlocked(actionData)") && chatSrc.includes("handleChatToolActionBlocked(res.action") && chatSrc.includes("handleChatToolActionBlocked(res.action, { source: \"file-upload\" })") && chatSrc.includes("options.toast === true"));
