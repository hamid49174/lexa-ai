...
assert("chat.js consumes extracted formatting helpers", !chatSrc.includes("function stripModelFunctionTags(") && !chatSrc.includes("function normalizeChatUrl(") && chatSrc.includes("stripModelFunctionTags(text)") && chatSrc.includes("normalizeChatUrl(match["));
