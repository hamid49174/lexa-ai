...
def test_registered_tools_have_explicit_confirmation_field():
    ...
    assert tool_registry.get_tool("file_write")["confirmation_required"] is True
    assert tool_registry.get_tool("env_get")["confirmation_required"] is True
    assert tool_registry.get_tool("env_list")["confirmation_required"] is True
    ...
    assert tool_registry.get_tool("desktop_engine_status")["confirmation_required"] is False
    assert tool_registry.get_tool("desktop_engine_observe")["confirmation_required"] is False
